    ...
    <body>
        <div id="container">
            <div id="container-div" class="center">    	
                ...
                <a href="<?php get_detail(3,'options','echo');?>"><img src="<?php get_detail(3,'options','echo'); get_detail(9,'options','echo');?>" alt=""></a>    
                </div>
                ...
                <div id="last-describ-opt">
                    <span id="last-describ-opt-like"><button class="button" id="liker" onclick="like(<?php get_detail(0,'info','echo');?>,<?php get_detail(4,'info','echo');?>,'<?php get_lang(14);?>','<?php get_lang(15);?>');"><?php get_lang(1);?></button> <span id="like_count">(<span id="like_count_num"><?php get_detail(4,'info','echo');?></span> <?php get_lang(2);?>)</span></span>
